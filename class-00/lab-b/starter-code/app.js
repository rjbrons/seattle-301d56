...
let objectList = () => ({ key1: 'value1', key2: 'value2', key3: 'value3' });
// TODO: Uncomment the following line of code to see the output in the browser console
...
console.log(joe.greeting('hello')); //this didn't break....
...
//  "this" is the windwo when an arrow func is used
// 3. Explain why "this" is different when an arrow function is used.
//  arrow funcs do now bind "this" so when you reference "this" it goes up to the last "binding" of "this" which is the window object in this case.
