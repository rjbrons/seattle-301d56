...
function displayPics() {
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT - The reason it threw an error is that the let rando is scoped to the while loop and only exists while that loop is running, then it gets trashed.  When the console log tries to access it later, it doesn't exist.
  console.log(viewed);
